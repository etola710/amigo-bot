...
MobilityRosAria::MobilityRosAria():
  linear_(0),
  angular_(0),
  l_scale_(2.0),
  a_scale_(2.0),
...
{
  ros::init(argc, argv, "mobility_RosAria");
  MobilityRosAria mobility_RosAria;
  signal(SIGINT,quit);
  mobility_RosAria.keyLoop();
  return(0);
}
void MobilityRosAria::keyLoop()
{
  char c;
  bool dirty=false;
